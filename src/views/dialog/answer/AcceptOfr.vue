      ...
      <v-card-actions class="ma-5">
        <v-row justify="center" class="text-center">
          <v-col cols="12" md="4" align-self="center">
            <v-btn size="large" block @click="clickCancel">취소</v-btn>
          </v-col>
          <v-col cols="12" md="4" align-self="center">
            <v-btn size="large" block @click="clickAccept">즉시 수락하기</v-btn>
          </v-col>
          <v-col cols="12" md="4" align-self="center">
            <v-btn size="large" block @click="clickChange">의뢰서 변경</v-btn>
          </v-col>
        </v-row>
      </v-card-actions>
    </v-card>
